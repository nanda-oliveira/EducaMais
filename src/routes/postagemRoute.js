...
router.delete("/delete/:id", controller.deletePostagem) //http://localhost:3030/postagem/deletar
router.patch("/update/:id", controller.updatePostagem) //http://localhost:3030/postagem/update
